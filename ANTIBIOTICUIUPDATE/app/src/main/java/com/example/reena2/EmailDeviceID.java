...
public class EmailDeviceID extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_device_id);

        Toolbar toolbar = findViewById(R.id.toolbarEmailDevice);
        toolbar.setTitle("Heart Rate Data");
        ...
        findViewById(R.id.buttonSubmitTokenPairedDeviceID).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EmailDeviceID.this,ReadMetrics.class));
            }
        });
        ...
        fromDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EmailDeviceID.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
